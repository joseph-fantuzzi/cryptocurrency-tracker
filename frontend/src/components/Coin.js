...
const Coin = ({ coin, toggleDark }) => {
  return (
    <Link to={`/coins/${coin.id}`}>
      <div
        className={`cursor-pointer hover:bg-gray-600 hover:text-white transition duration-300 ease max-w-7xl w-11/12 text-center mx-auto py-2 px-2 grid grid-cols-1 
