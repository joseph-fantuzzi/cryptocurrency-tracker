...
const LogoAnimation = ({ setShowLogoAnimation }) => {
  ...
  useEffect(() => {
    !(function (t, n) {
      ...
      function C(t, n, e) {
        return 0 === t ? n : 1 === t ? e : { x: T(t, n.x, e.x), y: T(t, n.y, e.y) };
      }
      function D(t, n, e) {
      ...
      function nt(t, n, r, i, u) {
        var o,
          ...
          f = U[r],
          s = N;
        switch ((a ? ((o = r.substr(1)), (r = o.replace(H, J))) : l && (r = r.substr(1)), e(f))) {
          case "function":
          ...
          case "string":
            ...
            break;
          case "object":
            if ((s = X(i, Z(f.i), f.f)) && "function" == typeof f.u) return f.u(n, s, r, a, t);
        }
        return s
          ? (function (t, n, e) {
        ...
        return a
          ? ((e = a),
            ...
            function (t, n) {
              ...
              var c = !1;
              if (s > a) (f = l), (c = !0), -1 === r.fill && (f = r.direction > 0 ? 0 : i);
      ...
      function ut(t, n) {
        if (((U = n), !t || !t.root || !Array.isArray(t.animations))) return null;
        var e = (function (t) {
      ...
      function at(t, n, e) {
        return !t || !e || n > t.length ? t : t.substring(0, n) + at(t.substring(n + 1), e, e);
      }
      function lt(t) {
            ...
            u(
              ...
              [
                ...
                },
                {
                  ...
                  value: function () {
                    var t = this,
                      n = window.__SVGATOR_PLAYER__ && window.__SVGATOR_PLAYER__["7c8cb2ed"];
                    Array.isArray(n) &&
        ...
        mt = {
          ...
          i: function (t, n, e) {
            return 0 === t
              ...
              : 1 === t
              ? e
              : { width: q(t, n.width, e.width), height: q(t, n.height, e.height) };
          },
          u: function (t, n) {
            return function (e) {
              var r = n(e);
      ...
      function Ft(t, n, e, r, i) {
        var u = arguments.length > 5 && void 0 !== arguments[5] && arguments[5],
          o = _t(t, n, e, r, i);
        return (
          o || (o = { x: Rt(t.x, n.x, e.x, r.x, i), y: Rt(t.y, n.y, e.y, r.y, i) }),
          u && (o.a = Nt(t, n, e, r, i)),
          o
        );
      }
      ...
      function Tt(t, n, e) {
        ...
        if (Lt(n)) {
          ...
          if (Dt(n)) return Ct(e) ? Ft(n, n.end, e.start, e, t, r) : Pt(n, n.end, e, t, r);
          if (Ct(e)) return Pt(n, e.start, e, t, r);
        }
        return Ot(n, e, t, r);
      }
              ...
              return (
                (function (t, n) {
                  for (var e = t.s, r = e.length; r < n.length; r++) {
                    ...
                    (i.id = Xt(i.id)), t.e.appendChild(i), (e = t.s = t.e.querySelectorAll("stop"));
                  }
      ...
      function Kt(t, n, e) {
        ...
        for (var r = Math.max(n.length, e.length), i = [], u = 0; u < r; u++) {
          var o = Wt(t, n[Math.min(u, n.length - 1)], e[Math.min(u, e.length - 1)]);
          i.push(o);
        }
        return i;
      }
          ...
          "#filter": function (t, n, e, r, i, u, o, a) {
            ...
            var l = (function (t, n) {
              var e = (t = t.map(function (t) {
                return t && en[t[0]]
                  ? (n.getElementById(t[1]), en[t[0]](n.getElementById(t[1]), t[1], n))
                  : null;
              })).length;
              return function (n) {
        ...
        animations: [
          {
            ...
            s: "MDA1OMzllNDVKODdDOTg5NVI4NDk3QOGM5MjkxNDU1ZDU2NTM1MzUzLNGY0NTg3OGM5NTg4ODY5NzhjEOTI5MTQ1NWQ1NDRmNDU4Yzk3CODg5NTg0OTc4YzkyUzkxOTZPPNDU1ZDU0NGY0NTg5OGM4ZjhmNNDU1ZDU0NGY0NVI4NFM4Zjk3MODg5NTkxODQ5Nzg4NDU1ZDg5YODQ4Zko5Njg4NGY0NTk2UTkzEODhIODg4NzQ1NWRMNTRhMA|",
          },
        ],
        options: "MDAxFMDhmMzY4Nzg4NzVCODY4ODM2SNGVXMzY4MFM4Mzc1NzgzNjkxQVw|",
      },
      "__SVGATOR_PLAYER__",
      window
    );
  ...
  return (
    <div className={"min-h-screen flex justify-center items-center bg-[#000924]"}>
      <svg
        className={"md:w-[15%] md:h-[15%] w-[30%] h-[30%]"}
        id="eXPwTO1x8UF1"
      ...
      >
        <defs>
          ...
          >
            <stop id="eXPwTO1x8UF2-fill-0" offset="0%" stopColor="#52e6fa" />
            <stop id="eXPwTO1x8UF2-fill-1" offset="100%" stopColor="#07112f" />
          </linearGradient>
        </defs>
        <ellipse
          id="eXPwTO1x8UF2"
        ...
        <line
          ...
          x2="19.215474"
          y2="0.062808"
          transform="matrix(-.888478 0 0-.997463 57.293403 36.374787)"
          opacity="0"
          fill="none"
          fillOpacity="0"
          stroke="#fff"
          strokeWidth="5"
          strokeLinecap="round"
          strokeDashoffset="38.431153"
          strokeDasharray="38.43"
        />
        <line
          id="eXPwTO1x8UF4"
          x1="-19.215474"
          ...
          x2="19.215474"
          y2="0.062808"
          transform="matrix(-.888478 0 0-.997463 46.92991 62.035604)"
          opacity="0"
          fill="none"
          stroke="#fff"
          strokeWidth="5"
          strokeLinecap="round"
          strokeDashoffset="38.43"
          strokeDasharray="38.431153"
        />
        <line
          id="eXPwTO1x8UF5"
          x1="-19.215474"
          ...
          x2="19.215474"
          y2="0.062808"
          transform="matrix(.599675 0.655578-.735995 0.673234 51.790146 48.860469)"
          opacity="0"
          fill="none"
          stroke="#fff"
          strokeWidth="5"
        ...
        <line
          ...
          x2="19.215474"
          y2="0.062808"
          transform="matrix(-.620839 0.635572-.713534-.696994 49.956097 48.519819)"
          fill="none"
          stroke="#fff"
          strokeWidth="5"
          strokeLinecap="round"
